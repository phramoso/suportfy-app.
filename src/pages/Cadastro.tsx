...
export default function Cadastro() {
  ...
  async function cadastrar(e: React.FormEvent) {
    ...
    if (!nome || !email || !senha || !telefone || !cpf || !cep || !bairro || !rua) {
      ...
      <div className="bg-slate-800 p-10 rounded-[2.5rem] shadow-xl border border-slate-700 w-full max-w-xl">
        ...
        <form onSubmit={cadastrar} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <input className={inputStyle} placeholder="Senha *" type="password" value={senha} onChange={(e) => setSenha(e.target.value)} />
          </div>
